...
const u8 gText_ForPetesSake[] = _("OAK: Going to battle, eh?…\p");
const u8 gText_TheTrainerThat[] = _("It's been ages since I've\nbeen this close to one!\p");
const u8 gText_TryBattling[] = _("Give it a shot, {B_PLAYER_NAME}!\p");
const u8 gText_InflictingDamageIsKey[] = _("OAK: Nice hit!\p");
const u8 gText_LoweringStats[] = _("OAK: Smart move…\p");
const u8 gText_KeepAnEyeOnHP[] = _("OAK: Watch out!\p");
const u8 gText_OakNoRunningFromATrainer[] = _("OAK: No! There's no running away\nfrom a TRAINER POKéMON battle!\p");
const u8 gText_WinEarnsPrizeMoney[] = _("OAK: Hm! Excellent!\p");
